...
*
* @version 1.3.1
* - override getViewPAth to set views path as parent directory of layout alias
*/
class RightsModule extends CWebModule
{
	...
	*/
    ...
    {
        return dirname(Yii::getPathOfAlias($this->layout)).DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR;
    }
}
