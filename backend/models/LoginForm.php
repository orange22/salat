...
class LoginForm extends CFormModel
{
            ...
            if(!$this->_identity->authenticate())
            {
                switch($this->_identity->errorCode)
                {
                    case UserIdentity::ERROR_USERNAME_INVALID:
                        $this->addError('email', Yii::t('backend', 'User not exists or account disabled.'));
                        break;
                    case UserIdentity::ERROR_PASSWORD_GUESSING:
     ...
     *
     * @return boolean whether email is successful
     */
